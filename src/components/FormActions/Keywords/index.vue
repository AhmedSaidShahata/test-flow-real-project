  ...
  <Form v-if="renderForm" @submit="submited($router)" class="mt-4">
    <v-row style="min-height: 47vh;">
      <v-col cols="12" md="4">
        <IntroSection
          v-if="isEdit"
          title="keywords_crud.intro_edit.title"
          description="keywords_crud.intro_edit.description"
        />
        <IntroSection
          v-else
          title="keywords_crud.intro_create.title"
          description="keywords_crud.intro_create.description"
        />
      </v-col>
      ...
      <v-col cols="12" md="8">
        <v-row class="px-5">
          ...
          <v-col cols="12" md="6">
            <InputText
              :hint="$t('keywords_crud.input.name_hint')"
              imageName="keywords-image.svg"
