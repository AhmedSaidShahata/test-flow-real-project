...
import { form, post, get, router, formData, submited, hasTitle, hasDescription } from './index.js'
  ...
  ;(form.value = {
    ...
    describe('called api create data', () => {
      return mockingApiCreate(
        wrapper,
        '/pages/home/sections/home_statistics',
        form,
        submited,
        post,
        formData(),
...
describe('test moking api show', () => {
  describe('called api show data', () => {
    return mockingApiGet(wrapper, '/pages/home/sections/home_statistics', 'handleShow', get)
  })
})
