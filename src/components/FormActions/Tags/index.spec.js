...
describe('test moking api create', () => {
    ...
    form.value = {
        ...
        describe('called api create data', () => {
            return mockingApiCreate(wrapper, '/tags', form, submited, post, formData(), router, '/tags')
        });
});
...
describe('test moking api update', () => {
    ...
    form.value = {
        ...
        describe('called api update data', () => {
            return mockingApiUpdate(wrapper, '/tags/1', form, submited, post, formData(), router, '/tags')
        });
});
...
describe('test moking api show', () => {
    describe('called api show data', () => {
        return mockingApiGet(wrapper, '/tags/1', 'handleShow', get)
    });
});
